# Malta SMP - Discord Server Bot

**Malta SMP** is a powerful, feature-rich Discord bot designed to enhance your server experience with comprehensive moderation tools, engaging economy systems, utility features, and much more. Built for the Malta SMP community.

[![Support Server](https://img.shields.io/badge/-Support%20Server-%231DB954?logo=discord&logoColor=white&style=flat-square&logoWidth=20)](https://discord.gg/rBUZUaXmwY)
...
- [Support Server](https://discord.gg/rBUZUaXmwY)
...
Malta SMP offers a complete suite of tools for Discord server management and community engagement:
...
### Video Tutorial
For a detailed step-by-step setup guide, visit our support server:
[**Malta SMP Discord Server**](https://discord.gg/rBUZUaXmwY)

## Docker Deployment (Recommended)

Malta SMP Bot is fully containerized for easy deployment.

1. **Clone the repository:**
   ```bash
   git clone https://github.com/discordprajusalt-creator/TitanBot.git
   cd TitanBot
   ```
...
```bash
docker pull ghcr.io/discordprajusalt-creator/titanbot:main
```
...
3. **Configure Environment Variables**
   ...
   POSTGRES_URL=postgresql://postgres:yourpassword@localhost:5432/malta_smp
   POSTGRES_HOST=localhost
   POSTGRES_PORT=5432
   POSTGRES_DB=malta_smp
   ...
   - If your chosen `PORT` is already used, Malta SMP automatically tries the next port(s)
...
4. **Setup PostgreSQL Database** (Optional but recommended)
   ...
   createdb malta_smp
   createuser malta_smp
   psql -c "ALTER USER malta_smp PASSWORD 'yourpassword';"
   psql -c "GRANT ALL PRIVILEGES ON DATABASE malta_smp TO malta_smp;"
   ```
...
Malta SMP requires the following Discord intents:
- **Guilds**
- **Guild Messages**
- **Message Content**
- **Guild Members**
...
We welcome contributions to Malta SMP! Here's how you can help:
...
Malta SMP Bot is released under the MIT License. See [LICENSE](LICENSE) for details.

## Support

Need help? Join our support server: [https://discord.gg/rBUZUaXmwY](https://discord.gg/rBUZUaXmwY)

## Thank You

Thank you for choosing Malta SMP Bot for your Discord server! We're constantly working to improve and add new features based on community feedback.
